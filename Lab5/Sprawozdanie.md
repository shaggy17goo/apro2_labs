...
Wykonanie tego programu mogło by skutkować "zaśmiecenie" całego dysku. Skutkiem wypakowywanie takiej bomby jest też to, że antyVirus ma dużą ilość plików do przeanalizowania,
z czym może się nie wyrabiać czasowo. Uruchamiając właściwego wirusa na koniec wypakowywania bomby może prowadzić do tego że antyVirus nie przeanalizuje i wykryje właściwego wirusa
